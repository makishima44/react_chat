...
const translations = {
  ru: {
    ...
    commonInstallApp: "Установить приложение",
    commonLogout: "Выход",
    commonRooms: "Комнаты",
    ...
    pwaInstallHint: "Откроется системное окно установки Chrome.",
    pwaInstallReady: "Можно установить на главный экран",
  ...
  en: {
    ...
    pwaInstallHint: "Chrome will open the system install prompt.",
    pwaInstallReady: "Ready to install to your home screen",
